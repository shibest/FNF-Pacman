...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pacman':
				tex = Paths.getSparrowAtlas('pacman','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'PACMAN IDLE instance 1', 24, false);
				animation.addByPrefix('singUP', 'PACMAN UP NOTE instance 1', 24, false);
				animation.addByPrefix('singDOWN', 'PACMAN DOWN NOTE instance 1', 24, false);
				animation.addByPrefix('singLEFT', 'PACMAN LEFT NOTE instance 1', 24, false);
				animation.addByPrefix('singRIGHT', 'PACMAN RIGHT NOTE instance 1', 24, false);
